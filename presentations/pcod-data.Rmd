...
```{r catch.5abcd, fig.width=8, fig.height=5}
...
```{r catch.3cd, fig.width=8, fig.height=5}
...
```{r fig-base-index-5abcd-2, fig.width=8, fig.height=5}
...
```{r fig-base-index-3cd, fig.width=8, fig.height=5}
...
```{r lengths-comm, fig.width=8, fig.height=5}
...
```{r lengths-surv, fig.width=8, fig.height=5}
