...
```{r catch.5abcd, dev='svg', fig.height=5, fig.width=9}
...
```{r catch.3cd, dev='svg', fig.height=5, fig.width=9}
...
```{r fig-base-index-fits-5abcd-1, dev='svg', fig.height=4, fig.width=12}
