...
```{r catch.5abcd, fig.height=5, fig.width=9}
...
```{r catch.3cd, fig.height=5, fig.width=9}
...
```{r fig-base-index-fits-5abcd-1, fig.width=8, fig.asp=0.4}
...
```{r fig-base-index-fits-5abcd-2, fig.height=4, fig.asp=0.5}
...
```{r fig-base-index-fits-3cd, fig.asp=0.25}
...
```{r lengths-comm, fig.asp=1.3, fig.width=4}
...
```{r lengths-surv, dev='svg', fig.height=5.5, fig.width=12}
