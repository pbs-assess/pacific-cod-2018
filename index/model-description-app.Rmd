...
\begin{equation}
\left\{ \begin{array}{l}{N_{2,1}} = {R_{Avg}}{e^{{\omega _1}}}\quad \quad \quad \quad \quad \quad \quad \quad a = 2\\{N_{a,1}} = \left( {{R_{AvgInit}}{e^{\omega Ini{t_a}}}} \right){e^{ - M\left( {a - 2} \right)}}\quad \;\quad 2 < a < A\\{N_{A,1}} = \frac{{\left( {{R_{AvgInit}}{e^{\omega Ini{t_A}}}} \right){e^{ - M\left( {A - 2} \right)}}}}{{\left( {1 - {e^{ - M}}} \right)}}\quad \quad a = A\end{array} \right\}
\end{equation}
