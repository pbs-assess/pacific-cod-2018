...
Coefficient plots from the full standardization models:
...
they are or are not present, we performed a simulation test. We parameterized
our simulation to approximately match the parameters estimated from observed
data. Our simulation included 20 years of data; 12 localities drawn from
a random effect distribution with a standard deviation of 0.3 and mean 0;
optionally year-locality random effects drawn from a distribution with
...
1 and a mean of 2; Tweedie parameters of $p = 1.6$ and $\phi = 5$. We generated
versions of this data set with and without the year-locality interactions and
then fit standardization models to those data sets that either allowed for or
ignored your-locality interactions.
