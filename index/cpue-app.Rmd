...
in the Tweedie [@foster2013; @lecomte2013].
...
space and allowing for the interactions has no qualitative effect on model
performance or coverage if the interactions are not present (Figure
