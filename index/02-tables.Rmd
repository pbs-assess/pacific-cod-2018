...
make.parameters.est.table(base.model.5abcd,
  caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
    ...
    "estimates of key parameters from the Reference Case, Area 5ABCD.",
    q.5abcd.desc),
...
make.parameters.est.table(base.model.3cd,
  caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
    "97.5\\textsuperscript{th} percentile) and MPD ",
    "estimates of key parameters from the reference Case, Area 3CD.",
    q.5abcd.desc),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.2[[1]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                  ...
                  "for Sc 2a (mean of the QCS Synoptic Survey was set to the same mean as for the HS Synoptic Survey), Area 5ABCD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.2[[2]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 2b (uniform priors for synoptic survey catchability), Area 5ABCD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.3[[1]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 3a (mean ln(M)=ln(0.5), SD=0.2), Area 5ABCD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.3[[2]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 3b (mean ln(M)=ln(0.4), SD=0.1), Area 5ABCD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.3[[3]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 3c (mean ln(M)=ln(0.4), SD=0.2), Area 5ABCD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.4[[1]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 4a (Uniform prior for steepness), Area 5ABCD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.4[[2]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 4b (beta prior for steepness with mean = 0.85 and SD = 0.15), Area 5ABCD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.6[[1]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 6a ($\\sigma_{O}$ = 0.1), Area 5ABCD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.6[[2]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 6b ($\\sigma_{O}$ = 0.15), Area 5ABCD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.6[[3]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 6c ($\\sigma_{O}$ = 0.25), Area 5ABCD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.9[[1]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 2a (sd of the WCVI Synoptic Survey was set to the same sd as for the QCS and HS Synoptic Surveys), Area 3CD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.9[[2]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 2b (uniform priors for synoptic survey catchability), Area 3CD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.10[[1]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 3a (mean ln(M)=ln(0.5), SD=0.2), Area 3CD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.10[[2]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 3b (mean ln(M)=ln(0.4), SD=0.1), Area 3CD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.10[[3]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 3c (mean ln(M)=ln(0.4), SD=0.2), Area 3CD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.11[[1]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 4a (Uniform prior for steepness), Area 3CD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.11[[2]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 4b (beta prior for steepness with mean = 0.85 and SD = 0.15), Area 3CD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.13[[1]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 6a ($\\sigma_{O}$ = 0.1), Area 3CD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.13[[2]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                   "for Sc 6b ($\\sigma_{O}$ = 0.15), Area 3CD."),
  omit_pars = pars_est_omit)
```
...
make.parameters.est.table(sens.models.13[[3]],
 caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                   "97.5\\textsuperscript{th} percentile) and MPD ",
                   "estimates of key parameters ",
                  "for Sc 6c ($\\sigma_{O}$ = 0.25), Area 3CD."),
  omit_pars = pars_est_omit)
```
...
```{r tab-decision-5abcd, results='asis', cache=FALSE}
...
```{r tab-decision-3cd, results='asis', cache=FALSE}
...
```{r tab-decision-avg-5abcd, results='asis', cache=FALSE}
decision.table(c(base.model.5abcd,
                 sens.models.6.sub),
               c(base.model.5abcd.name,
                 sens.models.name.6.sub),
               caption = "Decision table with model averaging for Area 5ABCD (see text).")
```

\clearpage

```{r tab-decision-avg-3cd, results='asis', cache=FALSE}
decision.table(c(base.model.3cd,
                 sens.models.13.sub),
               c(base.model.5abcd.name,
                 sens.models.name.13.sub),
               caption = "Decision table with model averaging for Area 3CD (see text).")
```
