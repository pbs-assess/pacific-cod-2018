...
df <- data.frame(referencepoint = c("Bmin",
                     ...
                     "F2017"),
                 Definition = c(
                   "Lowest estimated biomass agreed to be an undesirable state to avoid (2000 in  5ABCD; 1986 in 3CD)",
...
make.ref.points.table(c(base.model.5abcd,
                      ...
                      digits = 2,
                      caption = paste0("Posterior (2.5\\textsuperscript{th} percentile, Median, and ",
                                       "97.5\\textsuperscript{th} percentile) of proposed reference points for ",
