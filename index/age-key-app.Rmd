...
*TO DO: Add query details for length data (survey and comm).  See previous assessment and update with recent modifications if any. Do a similar summary as for ages. See GFplot*

Survey length, weight and maturity data were extracted from the GFBio database using the following criteria:

*TO DO: Add query details for survey data.* 

*TO DO: Improve bullets for commercial data below. Not really clear what it means*
