...
A summary of number of fish aged by year, survey and sex is provided in Table \@ref(tab:length-biosamples) ...
Survey length-frequencies are shown in Figure \@ref(fig:length-plotfrequencies) ...
...
```{r length-biosamples, results='asis'}
x %>%
...
```{r length-plotfrequencies, fig.cap="Length-frequencies of Pacific Cod taken in the Hecate Strait (SYN HS), Queen Charlotte Sound (SYN QCS) and West Coast Vancouver Island (SYN WCVI) synoptic surveys. Note that for clarity only male and female specimens are plotted."}
