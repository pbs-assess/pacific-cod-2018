...
```{r length-plot-frequencies, fig.cap="Length-frequencies of Pacific Cod taken in the commercial trawl fishery. For clarity only lengths since 1996 are shown.", fig.asp=1.2}
