...
\item[] \textbf{Sc 1b.} Use equations without the interaction term to create CPUE indices for historical and modern periods. Use the annual CVs resulting from the analysis as annual weighting terms in objective function of delay difference model (Equation TX.X).

\item[] \textbf{Sc 1c.} Use equations without the interaction term to create CPUE indices for historical and modern periods. Double the annual CVs resulting from the analysis directly as weighting terms in objective function of delay difference model (Equation TX.X).
