...
- The current model estimates only one average recruitment parameter ($R_{0}$). The models in @forrest2013 and @martell2011 estimated three average recruitment parameters:

  - $R_{0}$, average unfished recruitment used in derivation of stock-recruit parameters
  - $R_{Init}$, initial average recruitment used to initialize the age structure in the first year
...
- The von Bertalanffy growth parameters have been updated in the current assessment for both stocks, to reflect more recent age and length data. Details are provided in Appendix \@ref(analysis-of-biological-data).
...
> **Sc 2a.** The mean of the QCS Synoptic Survey was set to the same mean as for the HS Synoptic Survey, and was then pro-rated according to relative areas, i.e., mean $\ln(q)$ = $\ln(0.1869 \cdot 0.65)$.
...
3. the sensitivity case with prior for QCS $q$: $\ln(q)$ = $\ln(0.1869 \cdot 0.65)$ (Sc 2a);
4. the sensitivity case with prior for ln($M$): $\mathcal{N}\sim(0.4,0.2^2)$ (Sc 3b);
