...
Models were sensitive to priors assumed for the synoptic survey scaling parameters. Notably, removing the informative prior resulted in very low estimates of $q$ for these suveys (Tables ) and very large and uncertain estimates of biomass (Figures \@ref(fig:fig-sens2-biomass-5abcd) and \@ref(fig:fig-sens9-biomass-3cd)) and recruitment (Figures \@ref(fig:fig-sens2-recr-5abcd) and \@ref(fig:fig-sens9-recr-3cd)).
