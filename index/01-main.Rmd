...
1. The current model estimates only one average recruitment parameter ($R_{0}$). The models in @forrest2013 and @martell2011 estimated three average recruitment parameters:
  ...
  a. $R_{0}$, average unfished recruitment used in derivation of stock-recruit parameters
  b. $R_{Init}$, initial average recruitment used to initialize the age structure in the first year
  c. $R_{Avg}$, average recruitment for the time series)
...
Increasing $\sigma_W$ in Sc 7a resulted in a large reduction in estimated biomass in both areas (Figures \@ref(fig:fig-sens7-biomass-5abcd) and Figures \@ref(fig:fig-sens14-biomass-3cd)), but very poor fits to the average annual mean weight data (Figures \@ref(fig:fig-sens7-meanweightfit-5abcd) a and \@ref(fig:fig-sens14-meanweightfit-3cd) a). Decreasing $\sigma_w$ in Sc 7b did not have a noticeable effect on predicted biomass (Figures \@ref(fig:fig-sens7-biomass-5abcd) and \@ref(fig:fig-sens14-biomass-3cd)) or fits to the mean weight data (Figures Figures \@ref(fig:fig-sens7-meanweightfit-5abcd) b and \@ref(fig:fig-sens14-meanweightfit-3cd) b).
...
The decision table for the Area 5ABCD Reference Case model is provided in Table \@ref(tab:tab-decision-5abcd). Projections were done for a range of 2018 catch levels from `r dt.5abcd.min.catch`  metric tonnes (mt) to `r dt.5abcd.max.catch` mt, approximately three times the current combined Area 5ABCDE TAC of 950 mt (Table \@ref(tab:tab-tac)).

The probability of the 2019 biomass being below the 2018 biomass ranged from `r dt.5abcd.b.2019.2018.c0`% under no 2018 catch to `r dt.5abcd.b.2019.2018.cmax`% under a catch of `r dt.5abcd.max.catch` mt.

The probability of 2019 biomass being below the LRP ranged from `r dt.5abcd.b.2019.lrp.c0`% to `r dt.5abcd.b.2019.lrp.cmax`% over the range of catch levels considered. There was a `r dt.5abcd.b.2019.usr.cmax`% probability of the 2019 biomass being below the USR over the entire range of catch levels considered.

The probability of the 2018 fishing mortality being greater than the 2017 fishing mortality ranged from `r dt.5abcd.f.2018.2017.c0`% to `r dt.5abcd.f.2018.2017.cmax`%. The probability of the 2018 fishing mortality being greater than the LRR ranged from `r dt.5abcd.f.2018.lrr.c0`% to `r dt.5abcd.f.2018.lrr.cmax`%.

Under a 2018 catch level of 900 mt, close to the 2017 TAC, there is an estimated `r dt.5abcd.b.2019.lrp.c900`% probability that the 2019 biomass will be below the LRP and a `r dt.5abcd.b.2019.usr.c900`% probability that the 2019 biomass will be below the USR.

### Area 3CD

The decision table for the Area 3CD Reference Case model is provided in Table \@ref(tab: tab-decision-3cd). Projections were done for a range of 2018 catch levels from `r dt.3cd.min.catch` mt to `r dt.3cd.max.catch` mt, approximately three times the current TAC of 500 mt (Table \@ref(tab:tab-tac)).

The probability of the 2019 biomass being below the 2018 biomass ranged from `r dt.3cd.b.2019.2018.c0`% under no 2018 catch to `r dt.3cd.b.2019.2018.cmax`% under a catch of `r dt.3cd.max.catch` mt.

The probability of 2019 biomass being below the LRP ranged from `r dt.3cd.b.2019.lrp.c0`% to `r dt.3cd.b.2019.lrp.cmax`% over the range of catch levels considered. There was a `r dt.3cd.b.2019.usr.cmax`% probability of the 2019 biomass being below the USR over the entire range of catch levels considered.

The probability of the 2018 fishing mortality being greater than the 2017 fishing mortality ranged from `r dt.3cd.f.2018.2017.c0`% to `r dt.3cd.f.2018.2017.cmax`%. The probability of the 2018 fishing mortality being greater than the LRR ranged from `r dt.3cd.f.2018.lrr.c0`% to `r dt.3cd.f.2018.lrr.cmax`%.

Under a 2018 catch level of 500 mt, close to the 2017 TAC, there is an estimated `r dt.3cd.b.2019.lrp.c500`% probability that the 2019 biomass will be below the LRP and a `r dt.3cd.b.2019.usr.c500`% probability that the 2019 biomass will be below the USR.
...
A similar approach was used in the 2011 assessment of Pacific Hake [@stewart2011], where two alternative stock assessment models were judged by the Pacific Fishery Management Council's Scientific and Statistical Committee to be equally plausible. A similar "ensemble" approach is used in the annual assessments of Pacific Halibut, where four structurally distinct models are used [@stewart2016].
