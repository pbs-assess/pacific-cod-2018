...
Two additional analyses were done to bracket the considerable uncertainty in the scale of the stock.
...
As for Area 5ABCD, two additional analyses were done to bracket the considerable uncertainty in the scale of the stock.
...
## SC 7C.INFLUENCE OF HISTORICAL ANNUAL MEAN WEIGHT IN THE COMMERCIAL CATCH
...
1. $LRR$ (Limit Reference Rate) is the average fishing mortality rate from 1956--2004 (both areas).
...
@forrest2013 used a model-averaging approach to construct decision tables based on combined posterior samples from multiple sensitivity cases. They did this to address some of the key irresolvable uncertainties associated with the stock assessment.A similar approach was used in the 2011 assessment of Pacific Hake [@stewart2011], where two alternative stock assessment models were judged by the Pacific Fishery Management Council's Scientific and Statistical Committee to be equally plausible. A similar "ensemble" approach is used in the annual assessments of Pacific Halibut, where four structurally distinct models are used [@stewart2016].

In the following sections we present the Reference Case decision tables for each area, then present alternative "model-averaged" decision tables that incorporate the uncertainty from the Reference Case models (Section (\@ref(reference-case-models))) and a subset of the above sensitivity cases (Section (\@ref(sensitivity-analyses))). Details of the model averaging approach for Area 5ABCD and Area 3CD are provided below.
...
The decision table for the Area 5ABCD Reference Case model is provided in Table \@ref(tab:tab-decision-5abcd). Projections were done for a range of 2018 catch levels from `r dt.5abcd.min.catch`  metric tonnes (mt) to 3000 mt, approximately three times the current combined Area 5ABCDE TAC of 950 mt (Table \@ref(tab:tab-tac)).
...
The probability of the 2018 fishing mortality being greater than the 2017 fishing mortality ranged from `r dt.5abcd.f.2018.2017.c0`% to `r dt.5abcd.f.2018.2017.cmax`%. The probability of the 2018 fishing mortality being greater than the LRR also ranged from 0% to 100%.
...
The decision table for the Area 3CD Reference Case model is provided in Table \@ref(tab:tab-decision-3cd). Projections were done for a range of 2018 catch levels from `r dt.3cd.min.catch` mt to 1,500 mt, approximately three times the current TAC of 500 mt (Table \@ref(tab:tab-tac)).
...
The probability of 2019 biomass being below the LRP was 0% over the range of catch levels considered. There was a 98% to 99%  probability of the 2019 biomass being below the USR over the range of catch levels considered.

The probability of the 2018 fishing mortality being greater than the 2017 fishing mortality ranged from `r dt.3cd.f.2018.2017.c0`% to 100%. The probability of the 2018 fishing mortality being greater than the LRR also ranged from `r dt.3cd.f.2018.lrr.c0`% to 100%.
...
4. the sensitivity case with prior for ln($M$): $\mathcal{N}\sim(0.4,0.1)$ (Sc 3b);
...
The probability of 2019 biomass being below the LRP ranged from 82% to 96% over the range of catch levels considered. There was a 100% probability of the 2019 biomass being below the USR over the entire range of catch levels considered.
...
Under a 2018 catch level of 900 mt, close to the 2017 TAC, there is an estimated 89% probability that the 2019 biomass will be below the LRP and a 100% probability that the 2019 biomass will be below the USR.
...
The probability of the 2018 fishing mortality being greater than the 2017 fishing mortality ranged from 0% to 100% across the range of catch levels considered. The probability of the 2018 fishing mortality being greater than the LRR ranged from 0.0% to 98%.
