...
The reference case models were fit to historical and modern commercial CPUE indices that included a locality-year interaction as random effect (see Appendix \@ref(commercial-cpue-standardization), Equation \@ref(eq:cpue-locality-year)). Two sensitivity analyses are shown to illustrate the effect of omitting the locality-year interaction term from both historical and modern indices:
...
> model (Equation \@ref(eq:index-weighting)).
...
> function of delay difference model (Equation \@ref(eq:index-weighting)).
