...
1. Investigate application of a length-based model to characterize possible changes in selectivity in the trawl fishery, recognizing that length samples prior to 1996 under-represent smaller length classes.
