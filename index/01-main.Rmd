...
The potential scale reduction statistic is a common metric used in Bayesian statistics to assess chain convergence. It measures the the ratio of the average variance of MCMC samples within each chain to the variance of the samples across chains. In this case, we only had a single chain, but in following the advice of TODO and STAN REF, we first divided the chain into two before calculating it.
...
ensured that R < 1.05 (the potential scale reduction factor), and that the effective sample size, as calculated by the rstan R package (45), was >200 for all parameters (
