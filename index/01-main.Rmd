...
## Data choices
Both models were fit to observed catch data, observed mean weight data and fishery-independent and -dependent indices of abundance. 

Observed catch data is described in Section \@ref(data-sources) and provided in Tables XX and XX; and Figures \@ref(fig: fig-catch-5abcd) to \@ref(fig: fig-discards-5cd) for Area 5ABCD, and Figures \@ref(fig: fig-catch-3cd) to \@ref(fig: fig-discards-3cd) for Area 3CD.

Fishery independent indices are documented in Appendix \@ref(fishery-independent-indices-of-abundance). 
...
Fishery dependent indices are fully documented in Appendix \@ref(commercial-cpue-standardization). 

The CPUE time series are standardized GLMM split into two periods: historical (1956-1995) and modern (1996-2017).
...
Prior probability distributions for leading parameters in the Area 5ABCD and 3CD Reference Case models are provided in Tables \@ref(tab:priors-base5ABCD) and \@ref(tab:priors-base3CD).

\clearpage

*TO DO: Move these tables to Tables section*
