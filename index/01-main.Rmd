...
The statistic $n_\mathrm{eff}$ measures the effective number of MCMC independent samples after accounting for autocorrelation. For brevity we do not define the full calculation here, but it is available in [@gelman2014 p.286--287] or [@stan-manual2017 p. 373--376.]
...
1. *k* = Hecate Strait Synoptic Survey: Mean $\ln(q_{k})$ = $\ln(0.1869 \cdot
   0.35)$ = -2.727539;
...
We suggest inclusion of Sc 3b (both areas) in the ensemble of models for model-averaged decision tables (Section (\@ref(projections-and-decision-tables))), as this scenario resulted in the biggest difference in estimated biomass in both areas.
...
1. $USR$ (Upper Stock Reference) is the historical mean of the biomass estimates from 1956--2004 (both areas).
1. $LRP$ (Limit Reference Point) is the lowest biomass from which the stock recovered above the USR. For Area 5ABCD this is
  the biomass estimate for 1971. For Area 3CD it is the biomass estimate for 1986.
1. $LRR$ (Limit Reference Rate) is the Fishing mortality rate for the same years as the LRP.
