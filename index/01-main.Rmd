...
Pacific Cod in BC are caught almost entirely in the groundfish bottom trawl fishery, which is part of BC's integrated groundfish fishery [@dfo2017]. Pacific Cod is one of the principal target species of the trawl fishery in Hecate Strait. Currently, the majority of the BC Pacific Cod catch is taken from in Hecate Strait (Area 5CD) (Figures \@ref(fig:fig-catch-5ab),\@ref(fig:fig-catch-5cd) and \@ref(fig:fig-catch-3cd)).
