...
The probability of 2019 biomass being below the LRP $B_{1971}$ ranged from 88% to 98% over the range of catch levels considered.There was a 100% probability of the 2019 biomass being below the USR $B_{Avg}$ over the entire range of catch levels considered.
...
Under a 2018 catch level of 900 mt, close to the 2017 TAC, there is an estimated 92% probability that the 2019 biomass will be below $B_{1971}$ and a 100% probability that the 2019 biomass will be below $B_{Avg}$.
...
The probability of 2019 biomass being below the proposed LRP $B_{1986}$ was 0.0% over the entire range of catch levels considered. However, the probability of 2019 biomass being below the USR $B_{Avg}$ ranged from 98% to 99% over the entire range of catch levels considered.

The probability of the 2018 fishing mortality being greater than the 2017 fishing mortality ranged from 0.0% to 100%. The probability of the 2018 fishing mortality being greater than the LRR $F_{Avg}$ also ranged from 0.0% to 100%.

Under a 2018 catch level of 500 mt, the 2017 TAC, there is estimated 0.0% probability that the 2019 biomass will be below $B_{1986}$ and a 98% probability that the 2019 biomass will be below $B_{Avg}$.
...
The probability of 2019 biomass being below the LRP $B_{1971}$ ranged from 82% to 97% over the range of catch levels considered.There was a 100% probability of the 2019 biomass being below the USR $B_{Avg}$ over the entire range of catch levels considered.

The probability of the 2018 fishing mortality being greater than the 2017 fishing mortality ranged from 0.0% to 100%. The probability of the 2018 fishing mortality being greater than the LRR $F_{Avg}$ also ranged from 0.0% to 100%.

Under a 2018 catch level of 900 mt, close to the 2017 TAC, there is an estimated 89% probability that the 2019 biomass will be below $B_{1971}$ and a 100% probability that the 2019 biomass will be below $B_{Avg}$.
...
The probability of 2019 biomass being below the LRP $B_{1986}$ was 18% over the range of catch levels considered.The probability of 2019 biomass being below the USR $B_{Avg}$ ranged from 98% to 99% over the range of catch levels considered.

The probability of the 2018 fishing mortality being greater than the 2017 fishing mortality was 100% across the range of catch levels considered. The probability of the 2018 fishing mortality being greater than the LRR $F_{Avg}$ ranged from 0.0% to 98%.

Under a 2018 catch level of 500 mt, close to the 2017 TAC, there is an estimated 18% probability that the 2019 biomass will be below $B_{1971}$ and a 99% probability that the 2019 biomass will be below $B_{Avg}$.
