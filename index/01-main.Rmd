...
Performance measures were calculated over a sequence of alternative 2018 projected catch levels and are based on posterior samples for a one-year projection to the end of 2019. Uncertainty enters the projections through recruitment anomalies for the projection year, which were drawn randomly from a normal distribution, $\mathcal{N}(0,\sigma_R^2)$. The following performance measures were evaluated:
...
Posterior estimates of biomass from the model-averaged set are shown together in Figure \@ref(fig:fig-model-average-biomass-comp-3cd). The combined posterior estimates of biomass are shown in Figure \@ref(fig:fig-model-average-biomass-3cd). Projected biomass from the model-averaged set is shown in Figure \@ref(fig:fig-model-averaged-biomass-3cd).
...
helpful in future assessments for this and other stocks. More generally, her
help with the gfplot R package, and its carefully constructed SQL queries, made
the data extraction for this assessment seamless. We thank Norm Olsen for his advice on the historical commercial catch per unit effort reconstruction. We also thank Greg Workman and Maria Surry (Pacific Biological Station) for their support and advice with the
preparation for this assessment. We thank Bruce Turris and Brian Mose (Canadian Groundfish Research and Conservation Society) for their advice to the authors.Finally, we are extremely grateful to two reviewers, Ian Stewart (International Pacific Halibut Commission) and Daniel Ricard (Fisheries and Oceans Canada, Gulf Fisheries Centre), whose detailed reviews greatly improved the advice in this assessment.
