...
*TO DO: check catch numbers below once tables are in*

Prior to the introduction of at-sea observer coverage in 1996, estimates of at-sea releases (discards) for the period 1956-1995 were obtained from fishing logbooks. These estimates are considered an underestimate of the actual releases (Tables \@ref(tab:tab-catch-5abcd) and \@ref(tab:tab-catch-3cd)). Estimates in years following the introduction of 100% at-sea observer coverage in 1996 can be considered to be  accurate. Since 1996, the proportions of estimated discards have been considerably higher than in years before at-sea observers (Tables \@ref(tab:tab-catch-5abcd) and \@ref(tab:tab-catch-3cd)), especially in Queen Charlotte Sound, largely as a result of reduced total catches and TACs (Table \@ref(tab:tab-tac)). Pacific Cod can be legally discarded by trawlers in BC. However, on-board observers first estimate the quantity being discarded. This is assigned a discard mortality rate which is counted against the vessel's Pacific Cod quota. Therefore, in addition to greater accuracy in reporting of discards since 1996, incentives to avoid discarding have also been greater.
...
*TO DO: Find out why Appendix D (model-description-app.Rmd) is being referred to as a subsection of Appendix C: Appendix C.6.1.1 (Robyn only)*
...
The reference models for the Area 5ABCD and 3CD asessments are discussed in more detail in Section \@ref(reference-case-models).
...
In the current assessment, these reference points are incorporated into the decision tables (Section XX), where projected probabilities of breaching the reference points are reported, i.e., they are not incorporated into a formal harvest control rule.
...
* the Queen Charlotte Sound Synoptic Survey;
* the Hecate Strait Synoptic Survey.

For Area 3CD, these are:

* the West Coast Vancouver Island Synoptic Survey;
* the NMFS Triennial Survey (in Canada).
...
Details on the calculation of average annual mean weight in the commercial fishery are provided in Appendix \@ref(analysis-of-biological-data). Inclusion of average annual mean weight data is intented provide information about recruitment in the absence of age-composition data. This is dependent on the underlying assumption of the delay-difference model (Appendix \@ref(delay-difference-model)) that selectivity, growth and natural mortality are constant throughout the time period covered by the model (1956-2017). It is important to note that lower average annual mean weight in the commercial data could indicate a recruitment event, but could also have other causes including smaller proportions of older/larger fish due to fishing or natural mortality, changes in the spatial distribution of the fishery, or changes in growth.


## PRIOR PROBABILITY DISTRIBUTIONS AND FIXED VARIANCE PARAMETERS

The prior probability distributions for leading parameters in the Area 5ABCD and 3CD Reference Case models are provided in Tables \@ref(tab:tab-priors-5abcd) and \@ref(tab:tab-priors-3cd). Graphic presentation of prior probability distribution is provided in Figures \@ref(fig:fig-base-mcmc-priors-5abcd) and \@ref(fig:fig-base-mcmc-priors-3cd). Model sensitivities to prior assumptions are tested in section \@ref(sensitivity-analyses)

## LEADING PARAMETERS

A broad, uniform prior probability distribution was used for $\ln(R_0)$, reflecting ignorance the scale of the population.

A Beta distribution was used for steepness with shape parameters that resulted in a distribution with mean = 0.7 and SD = 0.15. These parameter choices resulted in a distribution with little to no probability density for values less than 0.2 (Figure \@ref(fig:fig-base-mcmc-priors-5abcd)), implying that no transformation was necessary.This is the same prior probability distribution accepted for use in the previous stock assessment [@forrest2013]. @sinclair2005 fixed steepness at 0.75 in one of their
"preferred" scenarios. In their other "preferred" scenario, the MPD estimate of steepness was 0.53. The prior probability distribution chosen here encompasses both of these values.
...
* Inclusion of a locality-year interaction as a random effect in the commercial CPUE data (historical period: pre-1996 and modern period: post-1995)
...
Resulting posterior estimates of biomass, recruitment and fishing mortality compared to the Reference Case models are shown in Figures \@ref(fig:fig-sens1-biomass-5abcd) to \@ref(fig:fig-sens1-f-5abcd) for Area 5ABCD and Figures \@ref(fig:fig-sens8-biomass-3cd) to \@ref(fig:fig-sens8-f-3cd) for Area 3CD.
...
Performance measures were calculated over a sequence of alternative 2018 projected catch levels and are based on a one-year projection to 2019. Uncertainty enters the projections through recruitment anomalies for the projection year, which were drawn randomly from a normal distribution, $\mathcal{N}\sim(0,\sigma_R)$.
...
The probability of the 2019 biomass being below the 2018 biomass ranged from 22.1\% under no 2018 catch to 87.5\% under a catch of 3,000 mt.

The probability of 2019 biomass being below the LRP $B_{1971}$ ranged from 85.5\% to 94.7\% over the range of catch levels considered.The probability of 2019 biomass being below the USR $B_{Avg}$ was higher and ranged from 99.5\% to 99.8\% over the range of catch levels considered.

The probability of the 2018 fishing mortality being greater than the 2017 fishing mortality ranged from 0.0\% to 100\%. The probability of the 2018 fishing mortality being greater than the LRR $F_{Avg}$ ranged from 0.0\% to 99.3\%.

Under a 2018 catch level of 900 mt, close to the 2017 TAC, there is an estimated 89.4\% probability that the 2019 biomass will be below $B_{1971}$ and a 99.5\% probability that the 2019 biomass will be below $B_{Avg}$.
...
The probability of the 2019 biomass being below the 2018 biomass ranged from 80.7\% under no 2018 catch to 92.3\% under a catch of 1,500 mt.

The probability of 2019 biomass being below the proposed LRP $B_{1986}$ ranged from 0.00\% to 0.003\% over the range of catch levels considered. However, the probability of 2019 biomass being below the USR $B_{Avg}$ ranged from 95.6\% to 97.1\% over the range of catch levels considered.

The probability of the 2018 fishing mortality being greater than the 2017 fishing mortality ranged from 0.0\% to 100\%. The probability of the 2018 fishing mortality being greater than the LRR $F_{Avg}$ ranged from 0.0\% to 97.7\%.

Under a 2018 catch level of 500 mt, the 2017 TAC, there is an estimated 0.001\% probability that the 2019 biomass will be below $B_{1986}$ and a 96.2\% probability that the 2019 biomass will be below $B_{Avg}$.
