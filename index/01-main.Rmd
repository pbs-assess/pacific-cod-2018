...
the historical commercial catch per unit effort data in consultation with Norm
Olsen (Pacific Biological Station). Her work on this important data set for this
assessment made it possible to have a fully reproducible analysis and will be
helpful in future assessments for countless other stocks. More generally, her
help with the gfplot R package, and its carefully constructed SQL queries, made
the data extraction for this assessment seamless. We also thank Greg Workman and
