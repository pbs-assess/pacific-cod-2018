...
vbp_wci <- filter(vbp, term == "k", surveys == "SYN WCVI") %>% pull(estimate) %>% round(3)
vbp_hsqcs <- filter(vbp, term == "k", surveys == "SYN HS, SYN QCS") %>% pull(estimate) %>% round(3)
vbp_all <- filter(vbp, term == "k", surveys == "SYN HS, SYN QCS, SYN WCVI") %>% pull(estimate) %>% round(3)
```
