...
get_par_df(vb_fits, 1) %>%
  ...
  knitr::kable(
    caption = "von Bertalanffy growth coefficients for Pacific Cod in the Hecate Strait (SYN HS), Queen Charlotte Sound (SYN QCS) and West Coast Vancouver Island (SYN WCVI) synoptic surveys. Rows in bold represent values used in the models.",
