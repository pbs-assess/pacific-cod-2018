...
```{r cpue-save}
readr::write_csv(cpue_pred_modern, "data/generated/cpue-predictions-modern.csv")
readr::write_csv(cpue_pred_hist, "data/generated/cpue-predictions-historical.csv")
```
