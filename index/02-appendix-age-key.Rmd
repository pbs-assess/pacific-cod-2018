...
```{r mat-figs, fig.cap = "Caption", fig.asp=1.7, fig.width=4.5, out.width="3.4in"}
...
```{r, fig.cap = "Caption", fig.width=6, out.width="4.5in"}
...
<!-- TODO: Fix color legends so they are consistent if no 0 -->
