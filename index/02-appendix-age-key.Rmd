...
```
a_50% = -(log((1 / 0.5) - 1) + a) / b
a = intercept, b = slope in logit space
```
...
```{r mat-figs, fig.cap = "Caption", fig.asp=2, fig.width=4, out.width="3.5in"}
