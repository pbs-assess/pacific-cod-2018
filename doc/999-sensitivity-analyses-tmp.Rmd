...
The base case models were fit to historical and modern commercial CPUE indices that included a year-location interaction as random effect (see model description and Appendix XX). For the historical \@ref(eq:cpuesenshist) and modern \@ref(eq:cpuesensmod) periods the GLMM *without* the interaction term is given by:
