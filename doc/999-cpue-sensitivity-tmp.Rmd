...
1. Lower (2.5th percentile), Median and Upper (97.5th percentile) posterior parameter estimates and MPD parameter estimates for **scenario 0_1a_5ABCD_BASE_loc-yr-interact_rsoleq_06_019**. q1 = HSMAS, q2 = QCSSS, q3 = HsSS, q4 = Historical CPUE (1956-1995), q5 = Modern CPUE (1996-2017).
...
colnames(pars) <- c("Lower","Median","Upper", "MPD")
rows_to_remove <- which(row.names(pars) %in% c("rbar","rinit","vartheta")) #remove fixed parameters
pars <- pars[-rows_to_remove,]
row.names(pars) <- c("R0", "Steepness", "M", "B0", "q1","q2","q3","q4","q5")

knitr::kable(pars, digits=3)

```

2. Lower (2.5th percentile), Median and Upper (97.5th percentile) posterior parameter estimates and MPD parameter estimates for **scenario 0_1b_5ABCD_NO_loc-yr-interact_rsoleq_06_019**. q1 = HSMAS, q2 = QCSSS, q3 = HsSS, q4 = Historical CPUE (1956-1995), q5 = Modern CPUE (1996-2017).
...
3. Lower (2.5th percentile), Median and Upper (97.5th percentile) posterior parameter estimates and MPD parameter estimates for **scenario 0_1c_5ABCD_NO_loc-yr-interact_rsoleq_06_019_doubleCV**. q1 = HSMAS, q2 = QCSSS, q3 = HsSS, q4 = Historical CPUE (1956-1995), q5 = Modern CPUE (1996-2017).
...
1. Lower (2.5th percentile), Median and Upper (97.5th percentile) posterior parameter estimates and MPD parameter estimates for **scenario 1_1a_3CD_BASE_loc-yr-interact_rsoleq_0228sd03**. q1 = WCVISS, q2 = Historical CPUE (1956-1995),q3 = Modern CPUE (1996-2017), q4 = NMFS Triennial Survey.
...
rows_to_remove <- which(row.names(pars) %in% c("rbar","rinit","vartheta")) #remove fixed parameters
pars <- pars[-rows_to_remove,]
row.names(pars) <- c("R0", "Steepness", "M", "B0", "q1","q2","q3","q4")

knitr::kable(pars, digits=3)

```

2. Lower (2.5th percentile), Median and Upper (97.5th percentile) posterior parameter estimates and MPD parameter estimates for **scenario 1_1b_3CD_NO_loc-yr-interact_rsoleq_0228sd03**. q1 = WCVISS, q2 = Historical CPUE (1956-1995),q3 = Modern CPUE (1996-2017), q4 = NMFS Triennial Survey.
...
3. Lower (2.5th percentile), Median and Upper (97.5th percentile) posterior parameter estimates and MPD parameter estimates for **scenario 1_1c_3CD_NO_loc-yr-interact_rsoleq_0228sd03_doubleCV**. q1 = WCVISS,  q2 = Historical CPUE (1956-1995),q3 = Modern CPUE (1996-2017), q4 = NMFS Triennial Survey.
