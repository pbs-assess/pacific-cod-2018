...
## ------------------------------------------------------------------------- ##
  6      6      6     6   6  # 1 -selectivity type ivector(isel_type) for gear
  1.5    1.5    1.5    1.5  1.5  # 2 -Age/length at 50% selectivity (logistic)
  0.0001 0.0001 0.0001  0.0001 0.0001 # 3 -STD at 50% selectivity (logistic)
  0      0      0   0  0       # 4 -No. of age nodes for each gear (0=ignore)
  0      0      0     0    0   # 5 -No. of year nodes for 2d spline(0=ignore)
 -1     -1     -1     -1   -1  # -6 -Phase of estimation (-1 for fixed) If neg number, it reflects a mirroring of another gear's selectivity.
150.0  200.0  200.0   200.0   200.0     # 7 -Penalty wt for 2nd differences w=1/(2*sig^2)
 50.0  200.0  200.0   200.0  200.0    # 8 -Penalty wt for dome-shaped w=1/(2*sig^2)
...
1     0   0  0 # -prior type (see legend above)
-1.47841    0.  0.  0.   # -prior log(mean)
0.3  1.0  1.0  1.0  # -prior sd
## ------------------------------------------------------------------------- ##
##
