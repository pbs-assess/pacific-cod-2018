...
```{r tab-tac}
tac.table(tac,
 cap = paste0("Sommaire des TAC par zone."), french = french)
```
...
suggested.ref.points(french=french)
```
...
make.ref.points.table(base.model.5abcd,
                      ...
                      digits = 2,
                      caption = paste0("Valeur a posteriori (centile 2,5\\textsuperscript{th, médiane et ",
                                       "Centile 97,5 \\textsuperscript{th}) des points de référence pour la zone 5ABCD. ",
