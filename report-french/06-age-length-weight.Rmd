...
colnames(biotable) <- c(latex.mlc(en2fr("Survey", translate = french, allow_missing = TRUE)),
                     ...
                     latex.mlc(en2fr(c("Max", "male", "(cm)"), translate = french, allow_missing = TRUE, case="sentence")),
                     latex.mlc(en2fr(c("Max", "female", "(cm)"), translate = french, allow_missing = TRUE, case="sentence")),
                     latex.mlc(en2fr(c("Max", "unsexed", "(cm)"), translate = french, allow_missing = TRUE, case="sentence")))
...
tidy_age_precision(d$age_precision, ageing_method_codes = 6) %>%
  ...
  xlab(en2fr("Secondary age (years)", translate=french, allow_missing=TRUE))+
  ggtitle("")
```
