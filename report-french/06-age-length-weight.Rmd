...
colnames(biotable) <- c(en2fr("Survey", translate = french, allow_missing = TRUE),
                     ...
                     latex.mlc(en2fr(c("N", "undetermined"), translate = french, allow_missing = TRUE)),
                     latex.mlc(en2fr(c("Max", "male", "(cm)"), translate = french, allow_missing = TRUE)),
                     latex.mlc(en2fr(c("Max", "female", "(cm)"), translate = french, allow_missing = TRUE)),
                     latex.mlc(en2fr(c("Max", "unsexed", "(cm)"), translate = french, allow_missing = TRUE)))
...
tidy_age_precision(d$age_precision, ageing_method_codes = 6) %>%
  ...
  xlab(en2fr("Primary age", translate=french, allow_missing=TRUE))+
  xlab(en2fr("Secondary age", translate=french, allow_missing=TRUE))+
  ggtitle("")
```
